 ...
 * @method Elements\Z1255 z1255(\stdClass $std) Constructor element 1255
...
final class Block1 extends Block
{
    ...
    public $elements = [
        ...
        'z1250' => ['class' => Elements\Z1250::class, 'level' => 2, 'type' => 'single'],
        'z1255' => ['class' => Elements\Z1255::class, 'level' => 3, 'type' => 'multiple'],
