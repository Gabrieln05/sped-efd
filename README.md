...
- **Estado:** leiautes **018, 019, 020 e 021** (períodos a partir de 2024). O 020 foi gerado e conferido contra a NT 2025.001 e o Guia Prático 3.2.2; 018 e 019 derivados dele para trás e 021 para frente (Guia Prático 3.2.3, CNPJ alfanumérico), pelas mudanças documentadas (ver `tools/leiaute/`). O 017 do upstream saiu. Validação dos arquivos de teste no PVA pendente.
